...
export const COMPANIES_HIERARCHY_SCHEMA_SQL = `
-- 16. Companies Table (Legal Entity) - Foundation for Multi-Company System
...
-- Backfill default company per tenant
...
SELECT 
  ...
  'SAR',
  'SA',
  jsonb_build_object('zatcaEnabled', true, 'zatcaEnv', 'simulation', 'defaultTaxRate', 0.15, 'currency', 'SAR', 'allowNegativeStock', false)
FROM tenants t
...
export const MIGRATIONS: MigrationStep[] = [
  ...
  },
  {
    ...
    description: 'Introduce companies as legal entities under tenants, add company_id to operational tables, create user_company_roles, idempotency_keys, audit_logs with RLS',
    sql: COMPANIES_HIERARCHY_SCHEMA_SQL,
  },
];
