...
import { getAi } from "../infrastructure/aiClient";
import { healthController, metricsController } from "../controllers/platformController";
...
export function createApiRouter() {
  ...
  router.get("/api/metrics", metricsController);

  // Outbox & Vector Clock Conflict Resolution Sync
  router.post("/api/sync/outbox", (req: Request, res: Response) => {
    try {
  ...
  router.post("/api/zatca/compliance-check", (req: Request, res: Response) => {
    try {
  ...
  router.post("/api/ai/pos-insights", async (req: Request, res: Response) => {
    try {
...
Provide a comprehensive, high-value executive intelligence brief in valid JSON format with the following keys:
{
  ...
  router.post("/api/ai/gateway/complete", async (req: Request, res: Response) => {
    try {
  ...
  router.post("/api/ai-apps/executive/what-if", (req: Request, res: Response) => {
    try {
      const {
  ...
  router.post("/api/ai-apps/cashier/voice-parse", (req: Request, res: Response) => {
    try {
      const { text = "" } = req.body;
  ...
  router.post("/api/ai-apps/orchestrator/execute", async (req: Request, res: Response) => {
    try {
  ...
  router.post("/api/ai-agents/workflows/run", (req: Request, res: Response) => {
    try {
  ...
  router.post("/api/ai-agents/approvals/:id/decide", (req: Request, res: Response) => {
    try {
      const { id } = req.params;
  ...
  router.get("/api/ai-agents/knowledge-graph/query", (req: Request, res: Response) => {
    try {
  ...
  router.post("/api/ai-agents/tools/execute", (req: Request, res: Response) => {
    try {
  ...
  router.post("/api/ai-agents/evaluations/run", (_req: Request, res: Response) => {
    try {
      return res.json({
        runId: `eval-${Date.now()}`,
  ...
  router.post("/api/cognitive-ai/voice/transcribe", (req: Request, res: Response) => {
    try {
  ...
  router.post("/api/cognitive-ai/voice/synthesize", (req: Request, res: Response) => {
    try {
  ...
  router.post("/api/cognitive-ai/voice/parse-command", (req: Request, res: Response) => {
    try {
  ...
  router.post("/api/cognitive-ai/vision/ocr", (req: Request, res: Response) => {
    try {
  ...
  router.get("/api/cognitive-ai/vision/kitchen-stream", (req: Request, res: Response) => {
    try {
  ...
  router.post("/api/cognitive-ai/creative/generate-image", (req: Request, res: Response) => {
    try {
  ...
  router.post("/api/cognitive-ai/digital-twin/simulate", (req: Request, res: Response) => {
    try {
